  ...
  return (
    <div className="flex-col py-[160px] bg-bgDark relative w-full">
      <div className="min-h-xl max-w-screen-lg m-auto flex-col justify-center">
        ...
        <div className="mt-[40px] bg-button-plan w-[226px] text-[16px] font-bold m-auto h-[48px] rounded-[12px] flex items-center justify-center">
          Start building —
          <span className="text-white-80 ml-1">it&apos;s free</span>
        </div>

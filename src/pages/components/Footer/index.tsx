          ...
          <div className="py-6 flex w-1/2 justify-between">
            ...
            <ul className="font-medium text-sm text-white list-none gap-4 space-y-3">
              ...
              <li className="text-[#D1D2D5] cursor-pointer">
                <div className="flex items-center">
                  <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11.333 14.3245H4.66634C2.66634 14.3245 1.33301 13.3245 1.33301 10.9912V6.32454C1.33301 3.99121 2.66634 2.99121 4.66634 2.99121H11.333C13.333 2.99121 14.6663 3.99121 14.6663 6.32454V10.9912C14.6663 13.3245 13.333 14.3245 11.333 14.3245Z" stroke="#D1D2D5" stroke-width="0.96" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M11.3337 6.6582L9.24699 8.32487C8.56032 8.87154 7.43366 8.87154 6.74699 8.32487L4.66699 6.6582" stroke="#D1D2D5" stroke-width="0.96" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                  <p className="ml-1">
                    contact@chatfly.co
                  </p>

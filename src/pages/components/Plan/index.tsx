...
export default function Plan() {
  ...
  return (
    <div className="flex-col py-[160px] bg-blue-dark relative w-full">
      <div className="min-h-xl max-w-screen-xl m-auto flex-col justify-center">
        <div className="flex relative w-fit m-auto text-white font-semibold text-[40px] leading-[52px]">
        ...
        <div className="flex relative justify-center text-[20px] font-normal mt-[32px] mb-[24px] text-white-80 leading-8">
